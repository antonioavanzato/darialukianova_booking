...
Форма показывает активные пакеты из коллекции `packages`. В форму идут
**индивидуальные** пакеты (по актуальному прайсу Дарьи); групповые форматы
(хор, мастер-класс, групповой вокал) оформляются через Telegram и в форму
не входят.
...
| title | description | price | lessonsCount |
|-------|-------------|------:|:---:|
| Пробное занятие | 50 минут · знакомство | 2 000 | 1 |
| Разовое занятие | 50 минут | 2 800 | 1 |
| Разовое занятие | 1 час 15 минут | 4 200 | 1 |
| Разовое занятие | 1 час 40 минут | 5 200 | 1 |
| Абонемент · 4 занятия | по 50 минут · 1 месяц | 10 400 | 4 |
| Абонемент · 8 занятий | по 50 минут · 2 месяца | 20 000 | 8 |
| Абонемент · 4 занятия | по 1 ч 15 мин · 1 месяц | 16 000 | 4 |
| Абонемент · 8 занятий | по 1 ч 15 мин · 2 месяца | 31 200 | 8 |
